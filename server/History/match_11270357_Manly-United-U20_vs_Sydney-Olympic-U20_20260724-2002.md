# Trận đấu — Manly United U20 vs Sydney Olympic U20
...
|--------|--------|
| Match ID | `11270357` |
| Giải | Australia New South Wales U20 League |
| Tỷ số | 1-0 |
| Thời điểm / trạng thái | FT |
| viewedAt (Unix ms) | 1784878108863 |
| timer (raw) | `{"tm":26,"ts":22,"tt":"1","ta":0,"md":0}` |
